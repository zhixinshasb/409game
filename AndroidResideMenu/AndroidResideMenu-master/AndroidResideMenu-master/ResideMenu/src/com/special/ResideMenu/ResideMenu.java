...
public class ResideMenu extends FrameLayout{
    ...
    private void initViews(Context context){
        ...
        userLever = (TextView)findViewById(R.id.user_lever);
        userGoald = (TextView)findViewById(R.id.user_goald); 
        nowTime = (TextView)findViewById(R.id.timer);
        /*****************************************/
    }
    ...
    public void openMenu(int direction){
        ...
        /*****************创建用户信息动画*********************/
        AnimatorSet alpha_userInfo = buildMenuAnimation(userInfo, 1.0f);
        AnimatorSet alpha_userInfoPhoto = buildMenuAnimation(userPhoto, 1.0f);
        AnimatorSet alpha_userInfoId = buildMenuAnimation(userName, 1.0f);
        AnimatorSet alpha_userInfoLevel = buildMenuAnimation(userLever, 1.0f);
        AnimatorSet alpha_userInfoGold = buildMenuAnimation(userGoald, 1.0f);
        /********************************************/
        ...
        scaleDown_activity.playTogether(alpha_userInfoId);
        scaleDown_activity.playTogether(alpha_userInfoPhoto);
        scaleDown_activity.playTogether(alpha_userInfoLevel);
        scaleDown_activity.playTogether(alpha_userInfoGold);
       /********************************************/
...
//    }
    ...
    public void setUserPhoto(int drawable) {
    	userPhoto.setImageResource(drawable);
    }
    ...
    public void setUserLevel (int userlevel) {
    	userLever.setText(""+userlevel);
    }
    
    public void setUserGoald(int usergaold) {
    	userGoald.setText(""+usergaold);
    } 

	public void setGreetTime(Time nowTime) {
		if (nowTime.hour >= 0 && nowTime.hour < 12) {
			this.nowTime.setText("早上好");
		} else if (nowTime.hour == 12) {
			this.nowTime.setText("中午好");
		} else if (nowTime.hour > 12 && nowTime.hour <= 18) {
			this.nowTime.setText("下午好");
		} else if (nowTime.hour > 18) {
			this.nowTime.setText("晚上好");
		}
	}
}
